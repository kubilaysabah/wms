...
<div class="relative inline-block" bind:this={dropdown_dom}>
    <button class="flex items-center justify-between pl-4 pr-1 py-2 bg-back text-reverse rounded-md border border-border-mid transition cursor-pointer" onclick={() => (open = !open)}>
    ...
    {#if open}
        <div class="absolute right-0 mt-2 min-w-40 bg-back border border-border-mid rounded-lg shadow-lg z-50 animate-fade-in p-2" tabindex="-1">
